DELIMITER $$
CREATE TRIGGER Update_VoteCount AFTER INSERT ON answer_text
FOR EACH ROW
BEGIN 
UPDATE answer_text_statistics
SET voteCount= (select count(*) from answer_text A NATURAL JOIN answer_text_statistics)
WHERE questionID= (select questionID from answer_text 
...
DELIMITER $$
CREATE TRIGGER Update_percent AFTER INSERT ON answer_choice
FOR EACH ROW
BEGIN
...
INSERT INTO survey VALUES (2);
INSERT INTO survey VALUES (3);
INSERT INTO survey VALUES (4);
INSERT INTO survey VALUES (5);
...
INSERT INTO Question VALUES ( 3,2,'How many classes sessions did you miss?','2');
INSERT INTO Question VALUES ( 4,2,'Does the professor demonstrate good knowledge of the class material?','1');
...
INSERT INTO Answer_Text VALUES (5,1,' This class taught me how to apply theory to practice',0);
INSERT INTO Answer_Text VALUES (4,2,'I think that the professor demonstrates good knowledge of the material',0);
